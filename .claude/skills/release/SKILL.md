...
source: botcore
description: >
  Version bump, changelog finalize, build, test, tag, publish to registries, and create GitHub Release. Language-aware for TypeScript (npm), Python (PyPI), and Rust (crates.io). Delegates to git-manager for tagging strategy and docs-manager for changelog format. Use when ready to release a new version.
